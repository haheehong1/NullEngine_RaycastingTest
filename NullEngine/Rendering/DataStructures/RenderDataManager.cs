...
namespace NullEngine.Rendering.DataStructures
{
    public class RenderDataManager
    {
        ...
        public dMesh addGbufferForID(int id, AABB boundingBox, Vec3 origin, Vec3 rotation, List<int> triangles, List<float> verts, List<float> uvs, List<int> materialIDs)
        {
