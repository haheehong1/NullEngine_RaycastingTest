...
namespace NullEngine.Rendering.DataStructures
{
    public class ColorGenerator
    {
        ...
        public class Turbo
        {
            public static double[,] turbo_colormap_data = new double[256, 3]
            ...
            public static Color ReturnTurboColor(double xx)
            {
                var x = Math.Max(0.0, Math.Min(1.0, xx));
                var a = (int)(x * 255.0);
                var b = Math.Min(255, a + 1);
                var f = x * 255.0 - a;

                var floatR = turbo_colormap_data[a, 0] + (turbo_colormap_data[b, 0] - turbo_colormap_data[a, 0]) * f;
                var floatG = turbo_colormap_data[a, 1] + (turbo_colormap_data[b, 1] - turbo_colormap_data[a, 1]) * f;
                var floatB = turbo_colormap_data[a, 2] + (turbo_colormap_data[b, 2] - turbo_colormap_data[a, 2]) * f;


                var rr = Convert.ToInt32(Math.Floor(floatR * 255));
                var gg = Convert.ToInt32(Math.Floor(floatG * 255));
                var bb = Convert.ToInt32(Math.Floor(floatB * 255));
        ...
        {
            public static double[,] inferno_colormap_data = new double[256, 3]
            ...
            public static Color ReturnInfernoColor(double xx)
            {
                var x = Math.Max(0.0, Math.Min(1.0, xx));
                var a = (int)(x * 255.0);
                var b = Math.Min(255, a + 1);
                ...
                var floatR = inferno_colormap_data[a, 0] + (inferno_colormap_data[b, 0] - inferno_colormap_data[a, 0]) * f;
                var floatG = inferno_colormap_data[a, 1] + (inferno_colormap_data[b, 1] - inferno_colormap_data[a, 1]) * f;
                var floatB = inferno_colormap_data[a, 2] + (inferno_colormap_data[b, 2] - inferno_colormap_data[a, 2]) * f;
